...
download() {
	...
	# base — pinned to 0.138.3.53 release date (2023-05-19)
	download_repo_zip "bmx-ng" "bmx-ng/bmx-ng" "3e8bee71320a21ff13efbd79579ada27dba7a91e" "zips/bmx-ng.zip"

	# apps
	download_repo_zip "bcc"    "bmx-ng/bcc"    "8887f74abf77d6d14f65516b8f227de2017cafd8" "zips/bcc.zip"
	download_repo_zip "bmk"    "bmx-ng/bmk"    "0272428e64c0fb3c7f2c5a2f7f6871104af1120c" "zips/bmk.zip"
	download_repo_zip "maxide" "bmx-ng/maxide" "306fde2021198fa5cc7509d5a9872613f2789d0b" "zips/maxide.zip"

	# modules
	declare -A MOD_SHA=(
		[brl]="afc2aa9f1beeeff3d426ce84f06fda28710cf500"
		[pub]="75b7926cc9d58056473449b4f1b7b42d14d35c8a"
		[maxgui]="c8b0edf7c54e13d26d6cb50daf7e7cdc21c9b0e8"
		[audio]="d78a86dc06ffbfdc0183392b360baaa7f8c4208b"
		[crypto]="a912c37a2a6bfe45ee17a89dc9ad0cb4963514c8"
		[image]="6469fa3fb80ac36d18ff1ef3fedf20c965451390"
		[mky]="c439e115fcc3c6ef767f0dd3280783ec5765e4b1"
		[net]="66e85bc40f18db19a4104b05ac85708e2ef066b3"
		[random]="0247b6bc93b8fcd2d127c0768eec893302cd6359"
		[sdl]="b4932798d7c47e852ec111c5d762cb4f047ae288"
		[steam]="7bf9eb41754f324f4240d01f35631ab88c11e774"
		[text]="795cee2d5c9bf396bde33b7568d17a1fcd7ec22d"
		[math]="b37407954306ea5b7d7330d7913e8ec9bb616122"
		[archive]="7f06338bb8acbfe33f966a242f1ba15d7e9a918a"
		[collections]="4678e6dd98bb4fe937b9d883b2df326a25de1289"
	)
	for mod in "${MOD_LIST[@]}"
	do
		download_repo_zip "${mod}.mod" "bmx-ng/${mod}.mod" "${MOD_SHA[$mod]}" "zips/${mod}.mod.zip"
	done
